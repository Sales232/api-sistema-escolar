...
Uma API REST desenvolvida em Python com FastAPI para gerenciamento completo de sistemas escolares. O projeto fornece endpoints para gerenciar alunos, turmas, disciplinas, matrículas e atribuições de professores.
